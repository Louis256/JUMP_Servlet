...
public class AboutUs extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>This is about us page</h1>");	
		/**
		...
		**/
		out.println("<nav aria-label=\"breadcrumb\">\n" + 
				...
				"    <li class=\"breadcrumb-item active\" aria-current=\"AboutUs\">About Us</li>\n" + 
				...
				"  </ol>\n" + 
				"</nav>");
		out.println("<span class=\"d-block p-2 bg-dark text-white\"><p>About me</p></span>");

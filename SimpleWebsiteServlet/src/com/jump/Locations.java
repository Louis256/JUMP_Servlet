...
public class Locations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>This is locations page</h1>");				
		/**
		...
		**/
		out.println("<nav aria-label=\"breadcrumb\">\n" + 
				...
				"    <li class=\"breadcrumb-item active\" aria-current=\"Locations\">Locations</li>\n" +
				"    <li class=\"breadcrumb-item\"><a href=\"Projects\">Projects</a></li>\n" +				
				"  </ol>\n" + 
				"</nav>");
		out.println("<span class=\"d-block p-2 bg-dark text-white\"><p>Location:</p></span>");
